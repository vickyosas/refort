                ...
                <div class="services-list row">
                    <div class="col-3 col-xs-12 col-md-4 col-sm-6">
                        <div class="service-inner">
                            <div class="service-thumbnail">
                                ...
                                <img width="370" height="200" src="assets/images/R/IMG-20190303-WA0050.jpg" alt="">
                            </div>
                            <div class="service-summary">
                                ...
                                <div class="service-content">
                                    <h2 class="service-title"><a href="#">Drainage construction</a></h2>
                    ...
                    <div class="col-3 col-xs-12 col-md-4 col-sm-6">
                        <div class="service-inner">
                            <div class="service-thumbnail">
                                <a href="#" class="pro-link"><i class="fa fa-link"></i></a>
                                <img width="370" height="200" src="assets/images/R/IMG_20180108_100239_1.jpg" alt="" />
                            </div>
                            <div class="service-summary">
                    ...
                    <div class="col-3 col-xs-12 col-md-4 col-sm-6">
                        <div class="service-inner">
                            <div class="service-thumbnail">
                                <a href="#" class="pro-link"><i class="fa fa-link"></i></a>
                                <img width="370" height="200" src="assets/images/R/IMG_20180108_100247_3.jpg" alt="" />
                            </div>
                            <div class="service-summary">
                                ...
                                <div class="service-content">
                                    <h2 class="service-title"><a href="#">Building contruction</a></h2>
                    ...
                    <div class="col-3 col-xs-12 col-md-4 col-sm-6">
                        <div class="service-inner">
                            <div class="service-thumbnail">
                                <a href="#" class="pro-link"><i class="fa fa-link"></i></a>
                                <img width="370" height="200" src="assets/images/R/IMG-20190707-WA0010.jpg" alt="" />
                            </div>
                            <div class="service-summary">
                                ...
                                <div class="service-content">
                                    <h2 class="service-title"><a href="#">Cranes and forklifts</a></h2>
                    ...
                    <div class="col-3 col-xs-12 col-md-4 col-sm-6">
                        <div class="service-inner">
                            <div class="service-thumbnail">
                                <a href="#" class="pro-link"><i class="fa fa-link"></i></a>
                                <img width="370" height="200" src="assets/images/R/IMG_20190301_155629_7.jpg" alt="" />
                            </div>
                            <div class="service-summary">
                                ...
                                <div class="service-content">
                                    <h2 class="service-title"><a href="#">Pipeline works</a></h2>
                    ...
                    <div class="col-3 col-xs-12 col-md-4 col-sm-6">
                        <div class="service-inner">
                            <div class="service-thumbnail">
                                <a href="#" class="pro-link"><i class="fa fa-link"></i></a>
                                <img width="370" height="200" src="assets/images/R/IMG_20190306_153745_3.jpg" alt="" />
                            </div>
                            <div class="service-summary">
                                ...
                                <div class="service-content">
                                    <h2 class="service-title"><a href="#">Pipeline Installation</a></h2>
